#ifndef COMPLEX_HPP // Queremos evitar que el archivo sea incluido más de una vez a la hora de compilar
#define COMPLEX_HPP // por eso usamos este "include guard" para evitar errores de multiples inclusiones
